@echo off
:: SMART TRAVEL automated setup script for Windows
:: Automates the setup process for the Smart Travel project

echo.
echo [94m====== SMART TRAVEL SETUP SCRIPT ======[0m
echo.
...
echo.
echo [94m====== Creating default superuser ======[0m
echo.
...
echo [92mCreated default superuser (username: admin, password: admin)[0m
echo [93mFor security in production environments, change this password immediately![0m
...
echo [92mSetup complete! Starting server at http://127.0.0.1:8000/[0m
